...
/*nested classes can't directly access members outside of it 
because they can't use the this pointer

However, because nested classes are members of the outer class, 
they can access any private members of the outer class 
that are in scope.*/
